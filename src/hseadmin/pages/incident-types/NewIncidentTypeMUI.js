...
const NewIncidentTypeMUI = () => {
  ...
  const postIncidentType = async (data) => {
    try {
      await fetchPOST(URLConstants.INCIDENT_TYPES_URL, data);
  ...
  return (
    <>
      <Helmet title="Add Incident Type" />
      ...
      <Grid justifyContent="space-between" container spacing={10}>
        <Grid item>
          ...
          <CustomBreadcrumbs aria-label="Breadcrumb" mt={2}>
            ...
            <Typography>Add Incident Type</Typography>
          </CustomBreadcrumbs>
        </Grid>
        <Grid item>
          <div>
...
export default NewIncidentTypeMUI;
