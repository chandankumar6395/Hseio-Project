...
const RequiredCertification = () => {
  ...
  const fetchRequiredCertification = async () => {
    try {
      setLoading(true);
      const response = await fetchGET(
        `${URLConstants.GET_REQUIRED_CERTIFICATION_URL}?limit=100&page=1`
      );
  ...
  return (
    <>
      <Helmet title="Required Certifications" />
      ...
      <Grid justifyContent="space-between" container spacing={10}>
        <Grid item>
          ...
          <Breadcrumbs aria-label="Breadcrumb" mt={2}>
            ...
            <Typography>Required Certification</Typography>
          </Breadcrumbs>
        </Grid>
        <Grid item>
          <div>
            <NavLink to="/private/required-certifications/add">
