...
const NewrequiredCertification = () => {
  ...
  const onRequiredCretificationChangeHandler = (event) => {
  ...
  const postRequiredCertification = async (data) => {
    try {
      await fetchPOST(URLConstants.REQUIRED_CERTIFICATIONS_URL, data);
  ...
  return (
    <>
      <Helmet title="Add Required Certification" />
      ...
      <Grid justifyContent="space-between" container spacing={10}>
        <Grid item>
          ...
          <CustomBreadcrumbs aria-label="Breadcrumb" mt={2}>
            ...
            <Link component={NavLink} to="/private/required-certifications">
              Required Certifications
            </Link>
            <Typography>Add Required Certifications</Typography>
          </CustomBreadcrumbs>
        </Grid>
        <Grid item>
          <div>
      ...
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Form
            noValidate
            validated={validated}
            onSubmit={onRequiredCretificationChangeHandler}
          >
            <Row>
              <Col md={6}>
                {/* Name Field */}
...
export default NewrequiredCertification;
