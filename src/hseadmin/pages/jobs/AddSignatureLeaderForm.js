...
import { getCurrentDateTime, toServerDateTime } from '../../utils/Utils';

const AddSignatureLeaderForm = ({ jobId, closeModal }) => {
  ...
  const [signatureDate, setSignatureDate] = useState(getCurrentDateTime);
...
export default AddSignatureLeaderForm;
