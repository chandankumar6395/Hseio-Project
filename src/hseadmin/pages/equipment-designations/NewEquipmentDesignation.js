...
const NewEquipmentDesignation = () => {
  ...
  const onEquipmentDesignationChangeHandler = (event) => {
  ...
  const postEquipmentDesignation = async (data) => {
    try {
      await fetchPOST(URLConstants.EQUIPMENT_DESIGNATIONS_URL, data);
      ...
      <Grid justifyContent="space-between" container spacing={10}>
        <Grid item>
          ...
          <CustomBreadcrumbs aria-label="Breadcrumb" mt={2}>
            ...
            <Link component={NavLink} to="/private/equipment-designations">
              Equipment Designations
            </Link>
            <Typography>Add Equipment Designation</Typography>
          </CustomBreadcrumbs>
        </Grid>
        <Grid item>
          <div>
      ...
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Form
            noValidate
            validated={validated}
            onSubmit={onEquipmentDesignationChangeHandler}
          >
            <Row>
              <Col md={6}>
                {/* Name Field */}
...
export default NewEquipmentDesignation;
