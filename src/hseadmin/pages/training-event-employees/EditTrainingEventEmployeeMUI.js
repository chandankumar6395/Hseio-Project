...
const EditTrainingEventEmployeeMUI = () => {
    ...
    useEffect(() => {
        if (trainingEventEmployee != null) {
            ...
            setCompletionDate(
                trainingEventEmployee.completion_date
                    ? toLocalDateTime(trainingEventEmployee.completion_date)
                    : ''
            );
        }
    ...
    return (
        <>
            <Helmet title="Edit Training Event Employee" />
            ...
            <Grid justifyContent="space-between" container spacing={10}>
                <Grid item>
                    ...
                    <CustomBreadcrumbs aria-label="Breadcrumb" mt={2}>
                        ...
                        <Typography>Edit Training Event Employee</Typography>
                    </CustomBreadcrumbs>
                </Grid>
                <Grid item>
                    <div>
...
export default EditTrainingEventEmployeeMUI;
