...
const NewRequiredCdlEndorsement = () => {
  ...
  const onRequiredCdlEndorsementChangeHandler = (event) => {
  ...
  const postRequiredCdlEndorsement = async (data) => {
    try {
      await fetchPOST(URLConstants.REQUIRED_CDL_ENDORSEMENTS_URL, data);
  ...
  return (
    <>
      <Helmet title="Add Required CDL Endorsement" />
      ...
      <Grid justifyContent="space-between" container spacing={10}>
        <Grid item>
          ...
          <CustomBreadcrumbs aria-label="Breadcrumb" mt={2}>
            ...
            <Link component={NavLink} to="/private/required-cdl-endorsements">
              Required Cdl Endorsement
            </Link>
            <Typography>Add Required Cdl Endorsement</Typography>
          </CustomBreadcrumbs>
        </Grid>
        <Grid item>
          <div>
      ...
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Form
            noValidate
            validated={validated}
            onSubmit={onRequiredCdlEndorsementChangeHandler}
          >
            <Row>
              <Col md={6}>
                {/* Name Field */}
...
export default NewRequiredCdlEndorsement;
