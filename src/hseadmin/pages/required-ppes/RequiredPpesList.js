...
const RequiredPpes = () => {
  ...
  const fetchRequiredPpes = async () => {
    try {
      setLoading(true);
      const response = await fetchGET(
        `${URLConstants.GET_REQUIRED_PPES_URL}?limit=100&page=1`
      );
      ...
      <Grid justifyContent="space-between" container spacing={10}>
        <Grid item>
          ...
          <Breadcrumbs aria-label="Breadcrumb" mt={2}>
            ...
            <Typography>Required Ppes</Typography>
          </Breadcrumbs>
        </Grid>
        <Grid item>
          <div>
            <NavLink to="/private/required-ppes/add">
